...
2.	Select the Play option (play-button icon).
 o	Wait for the map to generate.
 o	Observe the generated terrain.
 o	Start playing briefly and check the number and type of enemies in the first wave.
3.	Pause the game (normally by pressing Esc) and click Exit Game.
...
Goal: Verify that quitting the application entirely does not change the generation.
Steps:
 1.	Launch Mindustry.
